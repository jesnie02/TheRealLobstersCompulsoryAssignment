...
const Navigation = () => {
    return (
        <nav
            className="navigation top-0 left-0 right-0 flex justify-between items-center bg-lightPink text-black p-3 shadow-lg z-50 h-16">
            <div className="flex items-center w-full mx-8">
                <div>
                    <img src="/assets/LobsterPaperLogo.png" alt="Lobster Paper Logo"
