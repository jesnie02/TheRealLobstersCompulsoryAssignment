...
CREATE TABLE paper_attributes (
    ...
    CONSTRAINT paper_properties_property_id_fkey FOREIGN KEY (property_id) REFERENCES attributes (id)
);
...
CREATE INDEX "IX_paper_properties_property_id" ON paper_attributes (property_id);
...
INSERT INTO attributes (property_name) VALUES
    ('Property 1'),
    ('Property 2');
...
INSERT INTO paper_attributes (paper_id, property_id) VALUES
    (1, 1),
    (2, 2);
